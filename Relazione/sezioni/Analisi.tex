\section{Analisi}
    ...
    \subsection{Pagine del sito}
        ...
        \subsubsection{Eventi}
            ...
            \begin{itemize}
                \item Titolo dell’evento;
      	        \itemData in cui l’evento si svolge;
      	        \item Prezzo di acquisto del biglietto per l’evento in €;
	    ...
	    la mappa con le indicazioni per raggiungere il parco importata da Google Maps, nonostante non sia supportata da xhtml strict è stato scelto di tenerla dato che è compatibile con la maggior parte dei browser e fornisce un servizio non indifferente all’ utente che visita la pagina;
	    \begin{itemize}
            \item Un indirizzo email;
	        \item Un numero di telefono;
	        \item Un numero di fax;
            \item Una mappa con le indicazioni per raggiungere il parco importata da Google Maps, nonostante non sia supportata da xhtml strict è stato scelto di tenerla dato che è compatibile con la maggior parte dei browser e fornisce un servizio non indifferente all’ utente che visita la pagina;
